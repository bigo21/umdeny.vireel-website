...
const CONTENT = {
  fr: {
    banner: "Vous ne savez pas dans quoi investir ? Faites le quiz patrimonial gratuit et recevez votre analyse de profil.",
    ...
    hero: {
      ...
      cta2: "Passer à l'action sur umdeny.com",
      stats: [
      ...
      reelCaption: "« Investir, ça s'apprend. Pas dans un livre — sur le terrain. »",
    },
    ...
    about: {
      ...
      countries: ["Russie", "France", "Canada", "Gabon", "États-Unis", "Côte d'Ivoire", "Dubaï"],
      partnersTitle: "Nos partenaires & cadre réglementaire",
      partners: ["BVMAC", "BEM Securities", "Africa First Finance", "COGEP", "Cabinet Nemendi", "Korryx", "Exness", "FBS", "Fusion Markets", "HFM"],
      regulationsAfrica: "Régulations africaines",
      regulationsAfricaList: ["COSUMAF", "CEMAC", "COBAC", "ONECCA", "MINADER", "FSCA (Afrique du Sud)", "FSC (Maurice)"],
      regulationsIntl: "Régulations internationales",
      regulationsIntlList: ["FCA (UK)", "CySEC (Chypre)", "ASIC (Australie)"],
    },

    opportunities: {
      eyebrow: "02 — L'Opportunité est là",
      h2: "Êtes-vous prêt ?",
      ...
      cards: [
        {
          ...
          subBody: "Avec seulement six sociétés cotées à la BVMAC, l'entrée d'un groupe panafricain de cette envergure signale un point d'inflexion. Bénéfice net record 2024 : 122 Mds FCFA.",
        ...
        },
        {
          ...
          subBody: "Des discussions avancées sont engagées afin de permettre la cotation sur plusieurs marchés africains simultanément, dont la BRVM et la Bourse de Johannesburg.",
          tail: "Une opération financière transfrontalière inédite sur le continent africain.",
        },
      ],
      tradingTitle: "Le trading : des histoires réelles, des résultats concrets",
      tradingLead: "Le trading n'est pas réservé aux salles de marché de Londres ou New York. Des Africains le pratiquent au quotidien et en vivent — lorsqu'ils sont formés et disciplinés.",
      stories: [
        {
          name: "Koffi", age: "34 ans", city: "Abidjan",
          tag: "Trading Forex",
        ...
        {
          name: "Armand", age: "29 ans", city: "Yaoundé",
          tag: "Indices",
        ...
        {
          name: "Diane", age: "27 ans", city: "Douala",
          tag: "P2P · USDT",
        ...
        {
          name: "Bertrand", age: "32 ans", city: "Lyon (diaspora)",
          tag: "P2P · Arbitrage",
      ...
      footerLine: "Un trader régulier avec une gestion rigoureuse du risque peut viser entre 5 % et 15 % de rendement mensuel sur ses positions. Ces chiffres sont réels — ils ne sont pas garantis. Ils sont le résultat d'une méthode, pas d'un coup de chance.",
    },

    risks: {
      eyebrow: "03 — La face cachée",
      ...
      stats: [
        { num: "52 %", source: "ANTIC · 2023", text: "des cas de cybercriminalité signalés au Cameroun étaient liés à des arnaques crypto. Pertes estimées : 1,1 Md FCFA — près de 1,9 M USD." },
        { num: "×2", source: "Cybercriminalité financière", text: "Les pertes ont doublé entre 2019 et 2021 au Cameroun, passant à 12,2 Mds FCFA pour la seule année 2021." },
        { num: "300 000", source: "Affaire LimoCoin", text: "victimes de quarante nationalités différentes, pour un montant équivalent à la moitié du budget annuel du Cameroun." },
        { num: "10 000", source: "Yaoundé · Douala", text: "personnes ayant souscrit aux offres d'un individu promettant jusqu'à 15 % de rendement par semaine — jusqu'à son arrestation." },
      ],
      verityTitle: "Sur les rendements : la vérité que tout le monde ne dit pas",
      verityBody: "Oui, des rendements élevés existent sur ces marchés. Nous venons de vous en montrer des exemples réels. Mais ils ne peuvent pas être garantis, et ils sont souvent le fruit d'un contexte particulier — une période de marché favorable, une stratégie précise, des années de pratique.",
      verityRule: "Quiconque vous promet un rendement fixe élevé chaque semaine, sans conditions, sans risque mentionné, sans cadre réglementaire clair — ment.",
      verityClose: "Plus la promesse est haute et certaine, plus le risque est réel. La formation vous apprend à lire ces signaux avant qu'il ne soit trop tard.",
      tagline: "La formation n'est pas une option. C'est votre première ligne de défense — et votre meilleure stratégie de rendement.",
    },

    formations: {
      eyebrow: "04 — Nos Formations",
      ...
      formats: ["🎬 Vidéos", "🎙 Podcasts", "📄 Documents & présentations", "✅ Quiz de validation", "📋 Fiches pratiques", "👥 Accompagnement personnalisé"],
      cards: [
        {
          icon: "🏛",
          tag: "Disponible",
          ...
          bonus: [
            { t: "Accès à des SDB agréées", d: "Tous les investissements passent par des Sociétés de Bourse agréées, sous supervision de la COSUMAF." },
            { t: "Jusqu'à 5 % de décote", d: "Les apprenants qui investissent via Umdeny bénéficient d'une décote pouvant aller jusqu'à 5 % sur le prix d'acquisition." },
            { t: "Accompagnement personnalisé", d: "Pour ceux qui souhaitent être suivis étape par étape, notre équipe vous accompagne dans chaque décision d'investissement." },
          ],
          pricingTable: [
            { label: "Formation seule", crossPrice: "150 USD", price: "100 USD", suffix: "/ mois", xaf: "~ 60 000 XAF / mois", xafCross: "90 000 XAF" },
            { label: "+ Accompagnement personnalisé", price: "1 000 USD", suffix: " ponctuel", xaf: "~ 600 000 XAF" },
          ],
    ...
    testimonials: {
      ...
      items: [
        {
          quote: "Avant Vireel, je pensais que la bourse n'était pas pour nous. La formation m'a donné les outils — et la confiance — pour passer mon premier ordre. Six mois plus tard, je gère un petit portefeuille diversifié.",
          name: "Patricia M.", role: "Cadre RH · Libreville", profile: "Salariée",
        },
        {
          quote: "J'ai cherché pendant deux ans à comprendre le trading par moi-même. Les vidéos YouTube ne suffisaient pas. La formation Vireel a structuré ce que je faisais déjà — et m'a évité les erreurs qui auraient effacé mon capital.",
          name: "Thierry D.", role: "Entrepreneur · Yaoundé", profile: "Entrepreneur",
        },
        {
          quote: "Ce qui m'a convaincu, c'est que ce sont des praticiens qui gèrent réellement des portefeuilles. Pas des formateurs de plateforme. La différence se sent dès la première session.",
          name: "Marie-Claire B.", role: "Investisseuse · Diaspora · Paris", profile: "Investisseuse",
        },
        {
          quote: "Le P2P, je le faisais déjà — mais sans méthode et sans sécurité. La formation m'a permis de structurer mon activité, de protéger mon capital et de tripler mon volume mensuel.",
          name: "Joël K.", role: "Opérateur P2P · Douala", profile: "Indépendant",
        },
      ],
    },

    quiz: {
      eyebrow: "06 — Votre profil patrimonial",
      ...
      result: "À la fin, vous recevez directement par email une analyse complète et gratuite de votre profil investisseur — les véhicules adaptés, les formations recommandées, et les prochaines étapes concrètes.",
      cta: "Faire le quiz gratuitement",
      ctaSub: "quizz.umdeny.com · 8 minutes · gratuit",
      tail: "Pour découvrir l'ensemble des véhicules d'investissement disponibles → umdeny.com",
    },

    footer: {
      tagline: "Vireel est la branche formation d'Umdeny Capital — pour ceux qui veulent comprendre les marchés avant d'y entrer.",
      cols: [
        { title: "Formations", links: ["Bourse · disponible", "Trading · bientôt", "P2P · bientôt"] },
        { title: "Umdeny", links: ["Véhicules d'investissement", "umdeny.com", "Quiz patrimonial"] },
        { title: "Contact", links: ["vireel@umdeny.com", "Prendre rendez-vous", "Newsletter"] },
        { title: "Suivre", links: ["Instagram", "LinkedIn", "YouTube"] },
      ],
      legal: "© 2025 Vireel / Umdeny — Tous droits réservés",
      disclaimer: "Les performances et exemples cités sont basés sur des cas réels et des données de marché observées. Ils ne constituent pas une garantie de résultats. Tout investissement comporte des risques. Nos formations ont précisément pour objectif de vous aider à les comprendre et à les gérer.",
    },
  },

  en: {
    banner: "Not sure where to invest? Take the free wealth profile quiz and get your analysis.",
    ...
    hero: {
      ...
      cta2: "Already trained? Act on umdeny.com",
      stats: [
      ...
      reelCaption: "« Investing is a skill. Not learned in books — on the ground. »",
    },
    about: {
      eyebrow: "01 — About us",
      ...
      countries: ["Russia", "France", "Canada", "Gabon", "USA", "Côte d'Ivoire", "Dubai"],
      partnersTitle: "Partners & regulatory framework",
      partners: ["BVMAC", "BEM Securities", "Africa First Finance", "COGEP", "Cabinet Nemendi", "Korryx", "Exness", "FBS", "Fusion Markets", "HFM"],
      regulationsAfrica: "African regulations",
      regulationsAfricaList: ["COSUMAF", "CEMAC", "COBAC", "ONECCA", "MINADER", "FSCA (South Africa)", "FSC (Mauritius)"],
      regulationsIntl: "International regulations",
      regulationsIntlList: ["FCA (UK)", "CySEC (Cyprus)", "ASIC (Australia)"],
    },
    opportunities: {
      eyebrow: "02 — The opportunity is here",
      h2: "Are you ready?",
      ...
      cards: [
        {
          ...
          subBody: "With only six listed companies on the BVMAC, the entry of a pan-African banking group of this scale signals an inflection point. 2024 record net income: 122B FCFA.",
        ...
        },
        {
          ...
          subBody: "Advanced discussions are underway to enable simultaneous listing on multiple African markets, including the BRVM and the Johannesburg Stock Exchange.",
      ...
      tradingLead: "Trading isn't reserved for London or New York trading floors. Africans practice it daily and make a living from it — when properly trained and disciplined.",
      stories: [
        { name: "Koffi", age: "34", city: "Abidjan", tag: "Forex trading", body: "Accountant by training, started trading in 2020 with USD 500 after six months of intensive training. Conservative 3–5 % monthly strategy, strict risk discipline. Turned his account into a steady income stream, left his job two years later. Now trains other traders in Côte d'Ivoire.", metric: "500 → full-time income", metricLabel: "in 24 months" },
        { name: "Armand", age: "29", city: "Yaoundé", tag: "Indices", body: "Lost USD 800 on an unregulated platform in 2021 — no training, on a friend's advice. He decided to train seriously. Twelve months of work, a built strategy, mastered risk management: today he generates regular returns on index markets, from his phone.", metric: "Regular returns", metricLabel: "from his phone" },
        { name: "Diane", age: "27", city: "Douala", tag: "P2P · USDT", body: "Started P2P with 150,000 FCFA in 2022, after training on stablecoins and Binance P2P. Six months in, she had a regular client base — merchants needing USDT to pay Chinese suppliers. Six-figure monthly volume in FCFA, one assistant hired.", metric: "150K FCFA → 6-digit volume", metricLabel: "in 6 months" },
        { name: "Bertrand", age: "32", city: "Lyon (diaspora)", tag: "P2P · Arbitrage", body: "Cameroonian diaspora, uses P2P as a bridge between Europe and Cameroon — arbitraging rate gaps between European platforms and the Cameroonian market. Net margins of 4–6 % per transaction on USD 2,000–5,000 volumes, several times a week.", metric: "4–6 % margin", metricLabel: "per transaction" },
      ],
      footerLine: "A consistent trader with rigorous risk management can target 5 %–15 % monthly returns on their positions. These figures are real — they are not guaranteed. They are the result of a method, not luck.",
    },
    risks: {
      eyebrow: "03 — The other side",
      ...
      stats: [
        { num: "52 %", source: "ANTIC · 2023", text: "of cybercrime cases reported in Cameroon were tied to crypto scams. Estimated losses: 1.1B FCFA — nearly USD 1.9M." },
        { num: "×2", source: "Financial cybercrime", text: "Losses doubled between 2019 and 2021 in Cameroon, reaching 12.2B FCFA for 2021 alone." },
        { num: "300,000", source: "LimoCoin case", text: "victims of forty different nationalities, for an amount equal to half of Cameroon's annual budget." },
        { num: "10,000", source: "Yaoundé · Douala", text: "people had signed up to an individual promising up to 15 % weekly returns — until his arrest." },
      ],
      verityTitle: "On returns: the truth few will tell you",
      verityBody: "Yes, high returns exist on these markets. We just showed you real examples. But they cannot be guaranteed, and they often result from a specific context — a favourable market period, a precise strategy, years of practice.",
      verityRule: "Anyone promising fixed high returns every week, without conditions, no risk disclosed, no clear regulatory framework — is lying.",
      verityClose: "The higher and more certain the promise, the higher the real risk. Training teaches you to read those signals before it's too late.",
      tagline: "Training isn't optional. It's your first line of defence — and your best return strategy.",
    },
    formations: {
      eyebrow: "04 — Our programs",
      ...
      formats: ["🎬 Videos", "🎙 Podcasts", "📄 Docs & decks", "✅ Validation quizzes", "📋 Practical sheets", "👥 Personal coaching"],
      cards: [
        {
          icon: "🏛", tag: "Available", tagAccent: true,
          title: "Stock Market Program", subtitle: "Investing on Central African exchanges",
          ...
          curriculum: ["How the BVMAC and CEMAC markets operate", "Read and analyse a listed security — equities, bonds, sukuk", "Build a portfolio adapted to your risk profile", "Understand local tax and regulatory framework", "Place your first orders with confidence"],
          bonusTitle: "Included in the program",
          bonus: [
            { t: "Access to regulated brokers", d: "All investments go through licensed brokerage firms, supervised by the COSUMAF." },
            { t: "Up to 5 % discount", d: "Learners who invest via Umdeny get up to 5 % off the acquisition price." },
            { t: "Personal coaching", d: "For those who want step-by-step guidance, our team supports each investment decision." },
          ],
          pricingTable: [
            { label: "Program only", crossPrice: "150 USD", price: "100 USD", suffix: " / month", xaf: "~ 60,000 XAF / month", xafCross: "90,000 XAF" },
            { label: "+ Personal coaching", price: "1,000 USD", suffix: " one-off", xaf: "~ 600,000 XAF" },
          ],
        ...
        {
          icon: "💹", tag: "Soon",
          title: "Trading Program", subtitle: "Master the financial markets",
          ...
          curriculum: ["Applied technical and fundamental analysis", "Building a personal trading plan", "Risk management: sizing, stops, drawdown", "Psychology and operational discipline", "Tools, platforms, regulated brokers"],
          cta: "Join the waitlist", waitlist: true,
        },
        {
          icon: "💱", tag: "Soon",
          title: "P2P Program", subtitle: "Arbitrage & Virtual Assets",
          ...
          curriculum: ["Stablecoins, USDT and Mobile Money infrastructure", "Liquidity sourcing and margin structuring", "KYC compliance and security best practices", "Scaling B2C to B2B", "Accounting, tax and income reporting"],
          cta: "Join the waitlist", waitlist: true,
        },
      ],
    },
    testimonials: {
      ...
      items: [
        { quote: "Before Vireel, I thought the stock market wasn't for us. The training gave me the tools — and the confidence — to place my first order. Six months later, I run a small diversified portfolio.", name: "Patricia M.", role: "HR Manager · Libreville", profile: "Employee" },
        { quote: "I spent two years trying to understand trading on my own. YouTube videos weren't enough. Vireel's training structured what I was already doing — and spared me the mistakes that would have wiped my capital.", name: "Thierry D.", role: "Entrepreneur · Yaoundé", profile: "Entrepreneur" },
        { quote: "What convinced me is that these are practitioners who actually manage portfolios. Not platform trainers. The difference shows from the first session.", name: "Marie-Claire B.", role: "Investor · Diaspora · Paris", profile: "Investor" },
        { quote: "I was already doing P2P — but without method or security. The training let me structure my activity, protect my capital, and triple my monthly volume.", name: "Joël K.", role: "P2P operator · Douala", profile: "Self-employed" },
      ],
    },
    quiz: {
      eyebrow: "06 — Your wealth profile",
      ...
      result: "At the end, you receive by email a free, complete analysis of your investor profile — vehicles fit for you, recommended programs, and concrete next steps.",
      cta: "Take the quiz",
      ctaSub: "quizz.umdeny.com · 8 minutes · free",
      tail: "To explore the full range of investment vehicles → umdeny.com",
    },
    footer: {
      tagline: "Vireel is the training arm of Umdeny Capital — for those who want to understand the markets before stepping in.",
      cols: [
        { title: "Programs", links: ["Stocks · available", "Trading · soon", "P2P · soon"] },
        { title: "Umdeny", links: ["Investment vehicles", "umdeny.com", "Wealth quiz"] },
        { title: "Contact", links: ["vireel@umdeny.com", "Book a call", "Newsletter"] },
        { title: "Follow", links: ["Instagram", "LinkedIn", "YouTube"] },
      ],
      legal: "© 2025 Vireel / Umdeny — All rights reserved",
      disclaimer: "Performance and examples cited are based on real cases and observed market data. They do not constitute a guarantee of results. All investments carry risk. Our programs are designed precisely to help you understand and manage that risk.",
    },
  },
};
